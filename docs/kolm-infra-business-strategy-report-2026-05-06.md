...
| Compliance claims lack evidence | High | "HIPAA Security Rule mapped" and "EU AI Act compliant" are liabilities without documentation. | Publish BAA status, DPA, subprocessor list, risk-tier guidance, audit receipt example, and security roadmap. |
